...
public class GridFactory {
    ...
    // Start Game Music instancing
    GridFactory() {
        this.startSound = new Sound("/resources/kirby-gourmet-race.wav");
    }

    // Returns a new rectangle so we can use this method to create other grids and not only our main grid
    ...
    // Create Start Screen + Titles + Headers
