...
public class Score {
    ...
    public void actualScore(Food[] food, Picture pacMan, CountDownTimer countDownTimer3) {

        this.countDownTimer3 = countDownTimer3;

        // Play eat sound when food is eaten + increase score
    ...
    // Food Plate becomes Empty Plate
