...
public class EventHandler implements KeyboardHandler {
    ...
    public EventHandler(Rectangle rectangle, Picture picture, GridFactory gridFactory, CountDownTimer countDownTimer3) {
    ...
    public void keyPressed(KeyboardEvent keyboardEvent) {
        ...
        // Movement configuration when designated keys are pressed
    ...
    // Method for "on key released" keys (not used in this game yet)
    @Override
    public void keyReleased(KeyboardEvent keyboardEvent) {
    }

    // Alternating between the two pictures while moving to create animation illusion
